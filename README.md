-----------------------------------------------------------------------------------------------------------------------------------
⚠️ Disclaimer:
This project was developed as part of an academic course (Immersive Robotics).
It is intended strictly for educational and demonstration purposes.
No commercial distribution is intended.
-----------------------------------------------------------------------------------------------------------------------------------

Immersive Robotics Course Project – Unity Game
<img width="1472" height="704" alt="Gemini_Generated_Image_4dof224dof224dof (1)" src="https://github.com/user-attachments/assets/c00acaa6-ca12-4daf-a540-40f24a176d12" />
...
-American Sedans (Taxi, Police, Classic)
